...
// ----------------------------------------------------------------------
// 1. Reusable Tailwind Class Constants (Extracted to clean up JSX)
// ----------------------------------------------------------------------
...
const SocialButton = ({ icon, ariaLabel }: SocialButtonProps): JSX.Element => (
  <TERipple rippleColor="light">
    <button type="button" aria-label={ariaLabel} className={BUTTON_CLASSES.social}>
      {icon}
    </button>
  </TERipple>
);
        ...
        <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
          ...
          <div className="shrink-1 mb-12 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12">
            <img
              ...
              className="w-full"
              alt="Sample generic login illustration"
            />
          </div>
          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            <form>
              ...
              <TEInput type="password" label="Password" className="mb-6" size="lg" />

              {/* Remember Me & Forgot Password */}
              <div className="mb-6 flex items-center justify-between">
                <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                  <input className={CHECKBOX_CLASSES} type="checkbox" id="rememberMeCheck" />
                  <label className="inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="rememberMeCheck">
                    Remember me
                  </label>
                </div>
              ...
              <div className="text-center lg:text-left">
                <TERipple rippleColor="light">
                  <button type="button" className={BUTTON_CLASSES.login}>
                    Login
                  </button>
                </TERipple>
                ...
                <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
                  ...
                  <a href="/login" className="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">
                    Register
                  </a>
                </p>
              </div>
